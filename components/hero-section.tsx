...
import { PremiumProfileCard } from "@/components/premium/premium-profile-card"
...
export function HeroSection() {
  ...
  return (
    <section id="home" className="container mx-auto px-4 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32">
